...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-transparant">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('portofolio.index') }}">
                <img src="{{ asset('storage/posts/Logo2.png') }}" alt="Logo" width="50" height="50">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route('portofolio.index') }}">Rakpan</a>
                    </li>
                </ul>
    ...
    <!-- body -->
    <div class="wrapper">
        <img class="dewe" src="storage/posts/home.png" alt="Alat Berkebun">
        <div class="text-box">
            <h1>Mau Memancing?</h1>
            <p>Bingung mencari peralatannya?</p>
            <p>Tenang kami disini menyediakan, Kebutuhan memancing anda</p>
